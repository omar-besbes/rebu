...
def simulate_trip_end():
    ...
    try:
        response = requests.post(f"{INVOICE_GENERATION_APP}/generate_invoice", json=invoice_request)
...
@app.get("/trip/begin", response_model=TripBeginResponse)
